...
type subscribersTable struct {
	...
	SubscriberID postgres.ColumnInteger
...
func newSubscribersTableImpl(schemaName, tableName, alias string) subscribersTable {
	var (
		...
		SubscriberIDColumn = postgres.IntegerColumn("subscriber_id")
		allColumns         = postgres.ColumnList{IDColumn, CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn, UserIDColumn, SubscriberIDColumn}
		mutableColumns     = postgres.ColumnList{CreatedAtColumn, UpdatedAtColumn, DeletedAtColumn, UserIDColumn, SubscriberIDColumn}
	)

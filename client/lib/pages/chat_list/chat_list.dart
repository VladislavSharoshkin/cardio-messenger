...
import 'package:cardio_messenger/services/get_chats.dart';
...
import 'package:cardio_messenger/pages/chat_list/chat_list_view.dart';
import 'package:cardio_messenger/pages/chat_list/spaces_entry.dart';
...
class ChatListController extends State<ChatList> {
  ...
  int? get activeChat => int.parse(VRouter.of(context).pathParameters['roomid'] ?? '0');
  ...
  void _initReceiveSharingIntent() {
    ...
    if (CardioMessengerApp.gotInitialLink == false) {
      CardioMessengerApp.gotInitialLink = true;
      ...
      case PopupMenuAction.invite:
        FluffyShare.share(
            L10n.of(context)!.inviteText(Matrix.of(context).client.userID!,
                'https://matrix.to/#/${Matrix.of(context).client.userID}?client=im.cardiomessenger'),
            context);
        break;
  ...
  Future<void> _archiveSelectedRooms() async {
    ...
    //   }
    // }
    GetChats.del(selectedRoomIds.toList());
  }

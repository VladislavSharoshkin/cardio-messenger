...
import 'package:cardio_messenger/services/get_server_settings.dart';
...
import 'package:cardio_messenger/pages/homeserver_picker/homeserver_picker_view.dart';
import 'package:cardio_messenger/utils/famedlysdk_store.dart';
...
class HomeserverPickerController extends State<HomeserverPicker> {
  ...
  Future<void> checkHomeserverAction() async {
    ...
    try {
      var getServerSettings = await GetServerSettings.send(domain);
      registrationSupported = getServerSettings.serverSettings.registration;
      StoreHelper.shared.domain = domain;
    } catch (e) {

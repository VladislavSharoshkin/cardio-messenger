...
import 'package:cardio_messenger/widgets/public_room_bottom_sheet.dart';
...
class SearchController extends State<Search> {
  ...
  static const String _serverStoreNamespace = 'im.cardiomessenger.search.server';
  ...
  void searchUser(BuildContext context, String text) async {
    ...
    //   );
    // } catch (_) {}
    var getUsers = await GetUsers.search(text);
    foundProfiles = getUsers.users;

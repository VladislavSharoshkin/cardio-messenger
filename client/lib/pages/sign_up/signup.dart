...
import 'package:cardio_messenger/pages/sign_up/signup_view.dart';
...
class SignupPageController extends State<SignupPage> {
  ...
  void signup([_]) async {
    ...
    try {
      ...
      var getToken = await GetToken.reg(usernameController.text, passwordController.text, PushNotification.shared.getToken());
      StoreHelper.shared.token = getToken.token.token;

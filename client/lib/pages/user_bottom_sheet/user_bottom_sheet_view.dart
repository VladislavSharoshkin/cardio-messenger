            ...
            child: Scaffold(
                  ...
                  if (user.id != client.userID)
                    PopupMenuButton(
                      itemBuilder: (_) => [
                        ...
                        if (user.id != StoreHelper.shared.userID)
                          PopupMenuItem(
                            value: 'message',
                            child: _TextWithIcon(
              ...
              body: Column(
                children: [
                  ...
                  for (var userStaff in user.userStaffList)
                    ListTile(
                      title: Text(userStaff.branch.name),
                      subtitle: Text(userStaff.staff.name),

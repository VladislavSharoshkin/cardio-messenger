...
import 'package:cardio_messenger/pages/chat/chat_app_bar_title.dart';
import 'package:cardio_messenger/pages/chat/encryption_button.dart';
import 'package:cardio_messenger/pages/chat/pinned_events.dart';
import 'package:cardio_messenger/pages/chat/reactions_picker.dart';
import 'package:cardio_messenger/pages/chat/reply_display.dart';
import 'package:cardio_messenger/pages/chat/seen_by_row.dart';
import 'package:cardio_messenger/pages/chat/tombstone_display.dart';
import 'package:cardio_messenger/pages/chat/typing_indicators.dart';
...
import 'package:cardio_messenger/widgets/connection_status_header.dart';
import 'package:cardio_messenger/widgets/matrix.dart';
import 'package:cardio_messenger/widgets/unread_badge_back_button.dart';
  ...
  List<Widget> _appBarActions(BuildContext context) {
    if (controller.selectMode) {
      ...
      return [
        ...
        //     controller.chat!.type == ChatType.Single)
        //   IconButton(
  ...
  Widget build(BuildContext context) {
    ...
    return VWidgetGuard(
      ...
      child: GestureDetector(
        ...
        child: StreamBuilder(
          stream: null,//controller.room!.onUpdate.stream.rateLimit(const Duration(milliseconds: 250)),
                              ...
                              child: GestureDetector(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      ...
                                      if (controller.filteredEvents == null) {
                                        return const Center(
                                                    ...
                                                    : AutoScrollTag(
                                                        ...
                                                        child: Swipeable(
                                                          ...
                                                          child: Message(
                                                              ...
                                                              selected: controller
                                                                  .selectedEvents
                                                                  .any((e) => e.id == controller.filteredEvents![i - 1].id),
                                                              timeline: null, //controller.timeline!,

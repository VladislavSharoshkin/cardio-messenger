...
import 'package:cardio_messenger/pages/chat/events/video_player.dart';
...
class Attachment extends StatelessWidget {
  final MessageFile event;
  final Color textColor;
  final void Function(Event)? onInfoTab;

  const Attachment(this.event,
  ...
  Widget build(BuildContext context) {
    ...
    // event.senderId == StoreHelper.shared.userID ? textColor : null;
    ...
    //   return MessageDownloadContent(event, textColor);
    case FileType.file:
      return MessageDownloadContent(event.file, textColor);

...
import 'package:cardio_messenger/utils/uia_request_manager.dart';
import 'package:cardio_messenger/utils/voip_plugin.dart';
...
class MatrixState extends State<Matrix> with WidgetsBindingObserver {
  ...
  List<int>? get shareContent => _shareContent;

  set shareContent(List<int>? content) {
    _shareContent = content;
    onShareContentChanged.add(_shareContent);
  }

  List<int>? _shareContent;

  final StreamController<List<int>?> onShareContentChanged =

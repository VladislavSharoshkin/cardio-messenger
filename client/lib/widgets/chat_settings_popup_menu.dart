...
import 'package:cardio_messenger/pages/chat/cupertino_widgets_bottom_sheet.dart';
import 'package:cardio_messenger/pages/chat/edit_widgets_dialog.dart';
import 'package:cardio_messenger/pages/chat/widgets_bottom_sheet.dart';
import 'matrix.dart';
...
class _ChatSettingsPopupMenuState extends State<ChatSettingsPopupMenu> {
  ...
  void _showChatDetails() {
    if (VRouter.of(context).path.endsWith('/details')) {
      VRouter.of(context).toSegments(['rooms', widget.room.id.toString()]);
    } else {
      VRouter.of(context).toSegments(['rooms', widget.room.id.toString(), 'details']);
    }
  }
}
